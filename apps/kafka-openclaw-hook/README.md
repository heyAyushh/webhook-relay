...
- Forward to OpenClaw mapped hook `/hooks/agent` with retry/backoff.
...
- `KAFKA_TOPICS` (default examples: `webhooks.github,webhooks.linear`; set this to match your enabled sources)
